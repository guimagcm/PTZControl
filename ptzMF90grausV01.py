...
class tracking:
  ...
  # Calibracao: Conversao Angulo-tempo do Ptz (Uma nova unidade precisa recalibracao)
  ...
  def grabTLE(self):
    ...
    #Esta rotina pega automaticamente a TLE do satelite, caso esteja no arquivo cubesat
    #Caso nao encontre, na rotina colhe manualmente na rotina "else"
