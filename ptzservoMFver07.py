...
class tracking:
  ...
  AZfino = 42/355		# Calibracao tracking inicial 10-04-2019
  ELfino= 15.8/90		  # Calibracao tracking inicial 10-04-2019
  spaz= 0
  spel= 0
  spaz2 = 0
  spel2 = 0
  ...
  def grabTLE(self):
    self.target_url = "https://www.celestrak.com/NORAD/elements/active.txt"
  ...
  # Starts de todas as configuracoes possiveis de inicio do ptz
  def startAll(self):
    self.ptz.write(self.down)		#Nivel Zero na elevacao em 12.4s
    time.sleep(18)
    self.ptz.write(self.up)		#Nivel Zero na elevacao em 12.4s
    time.sleep(12.4)
  ...
  def azelTRK(self):
    ...
    self.getSatData()
    print('ROBUSTA 1-B: Azimute %5.1f deg, Elevacao %4.1f deg' % (self.spaz, self.spel))
    print("")
    self.spaz2 = self.spaz
    self.spel2 = self.spel
    self.spaz4 = 0
    self.spel4 = 0
    if self.spel <= 78 and self.spel > 2 and self.spaz >= 0 and self.spaz < 332:	#Deixando 332 como limite de azimute
      #azup
      if tr1.azheading >= 0 and tr1.spaz <= 180:
      ...
      time.sleep(self.spel*self.EL)
      self.ptz.write(self.stop)   
      # Tracking Incrementos
      while self.spel <= 78 and self.spel > 2 and self.spaz >= 0 and self.spaz < 332 and self.chosensat.range <= 4000000:	#Deixando 332 como limite de azimute
...
while 1:
  ...
  tr1.getSatData()
  tr1.sentidoAz()
  if tr1.chosensat.range <= 4000000:
    tr1.startAll()
    tr1.azelTRK()
    time.sleep(2)
    if tr1.chosensat.range > 4000000:
