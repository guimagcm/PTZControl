...
class tracking:
  ...
  def obs(self):
    ...
    self.chosensat = ephem.readtle('ISS',
  ...
  def azelTRK(self):
    ...
    self.spaz4 = 0
    self.spel4 = 0
    if self.spel <= 78 and self.spel > 0 and self.spaz >= 0 and self.spaz < 332:	#Deixando 332 como limite de azimute
      #azup
      if tr1.azheading >= 0 and tr1.spaz <= 180:
      ...
      while self.spel <= 78 and self.spel > 0 and self.spaz >= 0 and self.spaz < 332 and self.chosensat.range <= 3000000:	#Deixando 332 como limite de azimute
